      ...
      <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
            Why choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500">Splitwise</span>?
          </h2>
        ...
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500">
              2026 Splitwise. Made with <span className="text-red-500">?</span> for better expense management
            </p>
          </div>
        </div>
      </footer>
